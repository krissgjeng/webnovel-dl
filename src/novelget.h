...
public:
    ...
    virtual void getAllCb(std::function<void(int,std::string)> callback=[](int,std::string){},int delayinms=1000)=0;
    virtual void getChaptersCb(int from, int to, std::function<void(int,std::string)> callback=[](int,std::string){},int delayinms=1000)=0;
