...
public:
    StringHelper();
    static std::string Get(const std::string &source, const std::string &startstr, const std::string &endstr, bool inclusive=false, bool caseInsensitive=false);
    ...
    static int CountStr(const std::string& source, const std::string& strtofind);
